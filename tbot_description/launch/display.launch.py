...
def generate_launch_description():
    ...
    state_publisher_dir = os.path.join(get_package_share_directory('tbot_description'), 'launch')
    default_rviz_config_path = os.path.join(get_package_share_directory('tbot_description'), 'rviz/tortoisebot_sensor_display.rviz')
