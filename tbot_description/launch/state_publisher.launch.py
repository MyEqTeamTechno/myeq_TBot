...
def generate_launch_description():
    ...
    default_model_path = os.path.join(get_package_share_directory('tbot_description'), 'models/urdf/tortoisebot_simple.xacro')
    real_robot_model_path = os.path.join(get_package_share_directory('tbot_description'), 'models/urdf/tortoisebotreal.xacro')
